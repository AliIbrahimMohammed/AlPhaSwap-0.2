const styles = {
  ...
  headTitle: "text-indigo-500 font-poppins font-black text-5xl tracking-wide",
  subTitle: "text-dim-white font-poppins font-medium mt-4 text-base",
  exchangeBoxWrapper: "mt-10 w-full flex justify-center focus:ring-2 focus:ring-blue-600",
  exchangeBox:
  ...
  // WalletButton
  walletButton:
    "bg-site-pink border-none outline-none bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",
